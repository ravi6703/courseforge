      ...
      {brief && view === "brief" && expanded && (
        <div className="border-t border-slate-100 px-4 py-4 space-y-4 text-sm">
              ...
              {!suggestion && (
                <>
                  ...
                  <div className="flex gap-2">
                    ...
                    <button onClick={() => { setSuggestOpen(false); setSuggestFeedback(""); }} className="px-3 py-1.5 rounded-md border border-slate-300 text-xs hover:bg-white">Cancel</button>
                  </div>
                </>
              )}
              {suggestion && (
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button onClick={() => setSuggestion(null)} className="inline-flex items-center gap-1 px-3 py-1.5 rounded-md border border-slate-300 text-xs hover:bg-white">
          ...
          <div className="rounded-md border border-dashed border-slate-300 p-3 flex items-center justify-between">
            ...
            <a href={`/course/${courseId}/ppts`} className="text-xs text-blue-600 hover:underline font-medium">
              Go to PPT tab →
            </a>
          </div>
        </div>
