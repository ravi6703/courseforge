                ...
                <td className="px-4 py-2 text-right align-top">
                  <div className="inline-flex gap-1">
                    <button
                      ...
                      className="text-xs px-2 py-1 rounded border border-blue-300 text-blue-700 bg-blue-50 hover:bg-bi-blue-100 disabled:opacity-40 inline-flex items-center gap-1"
